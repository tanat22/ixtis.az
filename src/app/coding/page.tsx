...
const calculateProbability = (userScore: number, specialtyScore: number | null | undefined): number => {
  ...
  // Sigmoid-like function to map score difference to a probability
  ...
  return Math.max(1, Math.round(10 + (scoreDiff + 50) / 5)); // Ensure a minimum of 1% for very low scores
};
...
export default function CodingPage() {
  ...
  const { selectedList, addToSelection, userScore, setUserScore } = useSelection();
      ...
      <div className="w-full max-w-7xl">
        <header className="mb-8 text-center">
          ...
          <p className="mt-2 text-muted-foreground">
            Seçim etmək üçün təkmil filtrlərdən istifadə edin.
          </p>
        </header>
           ...
           <CardHeader>
             <div className="flex flex-wrap justify-between items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                    <Label htmlFor="user-score" className="shrink-0 text-sm font-medium">Topladığınız bal:</Label>
                    <Input
                    id="user-score"
                    type="number"
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-right">Seçim</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {loading ? (
                      ...
                      return (
                        <TableRow key={spec.id}>
                          ...
                          <TableCell className="font-medium">
                            ...
                            <p className="text-xs text-muted-foreground">{getUniversityName(spec.universityId)}</p>
                          </TableCell>
                            ...
                            >
                                {userScore > 0 ? (
                                  <span className="flex items-center">
                                    <span className="mr-2 font-semibold">Ehtimal: {probability}%</span> | <PlusCircle className="ml-2 h-4 w-4"/> Seç
                                  </span>
                                ) : (
                                  <span className="flex items-center">
                                    <PlusCircle className="mr-2 h-4 w-4"/> Seç
                                  </span>
                                )}
                            </Button>
                          </TableCell>
                    ...
                    <TableRow>
                      <TableCell colSpan={6} className="h-24 text-center">Nəticə tapılmadı.</TableCell>
                    </TableRow>
                  )}
                </TableBody>
              </Table>
                      ...
                      return(
                        <Card key={spec.id} className="overflow-hidden">
                          <CardContent className="p-4 space-y-3">
                            ...
                            <div className="grid grid-cols-3 gap-x-2 gap-y-3 text-xs pt-2">
                                ...
                                <div className='space-y-1'><p className="text-muted-foreground">Keçid Balı</p><p className="font-bold font-mono">{spec.score ?? '-'}</p></div>
