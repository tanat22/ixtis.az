...
export const mockNodes: TasinmazEmlak[] = [
    ...
    { id: 'ts-4', type: 'Metro', name: '28 May', stansiya: '28 May', seher: 'Bakı', rayon: 'Nəsimi', layihe: 'Metro Stansiyaları', dataMenbeyi: 'Optik', koordinatX: '49.8499', koordinatY: '40.3798', photo: null },
];


export const mockAssets: Asset[] = [
  // Assets for TS-1 (Təhlükəsizlik Nöqtəsi)
  { 
    id: 'asset-1', 
    nodeId: 'ts-1',
    name: 'TŞ4-952-Dirək', 
  ...
  { 
    id: 'asset-2', 
    nodeId: 'ts-1',
    parentId: 'asset-1', // Attached to the pole
    name: 'TŞ4-952-Qutu', 
    type: 'Qutu', 
    region: 'Bakı', 
    location: { lat: 40.3792, lng: 49.8492 }, 
  ...
  } as QutuAsset,
  {
    id: 'asset-9',
    nodeId: 'ts-1',
    parentId: 'asset-2', // Inside the box
    name: 'TŞ4-952-SW-1',
    type: 'Switch',
    region: 'Bakı',
    location: { lat: 40.3792, lng: 49.8492 },
  ...
  { 
    id: 'asset-3', 
    nodeId: 'ts-1',
    parentId: 'asset-9', // Connected to the switch
    name: 'TŞ4-952-CAM-1', 
    type: 'Kamera', 
    region: 'Bakı', 
    location: { lat: 40.3792, lng: 49.8492 }, 
  ...
  // Assets for TS-2 (Alt Keçid) - NO POLE (DIRƏK) ALLOWED
  { 
    id: 'asset-11', 
    nodeId: 'ts-2',
    name: 'Sumqayıt-AK1-Qutu-1', 
    type: 'Qutu', 
    region: 'Sumqayıt', 
    location: { lat: 40.5917, lng: 49.6676 }, 
    status: 'Aktiv', 
    addedBy: 'user-4', 
  ...
  { 
    ...
    addedDate: '2023-11-05',
    marka: 'Hikvision',
    model: 'Switch Hikvision DS-3E2510P POE',
  },

  // Assets for TS-3 (Ticarət Mərkəzi) - NO POLE, can have multiple boxes
  {
    id: 'asset-13',
    nodeId: 'ts-3',
    name: 'GənclikMall-Qutu-M1',
    type: 'Qutu',
    region: 'Bakı',
    location: { lat: 40.3981, lng: 49.8532 },
    status: 'Aktiv',
    addedBy: 'user-3',
  ...
  } as QutuAsset,
  {
    id: 'asset-15',
    nodeId: 'ts-3',
    parentId: 'asset-13', // In the first box
    name: 'GənclikMall-SW-1',
    type: 'Switch',
    region: 'Bakı',
    location: { lat: 40.3981, lng: 49.8532 },
    status: 'Aktiv',
    ...
    addedDate: '2024-01-15',
    marka: 'Cisco',
    model: 'Cisco Industrial Switch IE-2000-16PTC-G-E',
  },
...
export const mockTickets: Ticket[] = [
  ...
  { id: 'ticket-2', assetId: 'asset-12', issue: 'Switch portlarından biri işləmir', status: 'Açıq', assignedTo: 'user-4', createdDate: '2023-11-22', priority: 'Orta' },
...
export const mockAuditLogs: AuditLog[] = [
  ...
  { id: 'log-4', userId: 'user-4', action: 'Asset Statusu Dəyişdirildi', timestamp: '2023-11-21T15:30:00Z', details: 'Asset-12-nin statusu Aktiv olaraq dəyişdirildi' },
